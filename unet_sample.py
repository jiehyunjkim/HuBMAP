...
test_img = cv2.imread('/Users/jiehyun/kaggle/input/hubmap-organ-segmentation/train_images/62.tiff', 0)
...
plt.imsave('/Users/jiehyun/kaggle/output.jpg', segmented, cmap='gray')
